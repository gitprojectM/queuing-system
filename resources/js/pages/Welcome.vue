            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    ...
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        <li class="py-2 text-[#f53003] dark:text-[#FF4433] font-semibold">
                    ...
                    <ul class="flex gap-3 text-sm leading-normal">
                        ...
                        <li>
                            <Link
                                ...
                                class="inline-block rounded-sm border border-[#f53003] bg-[#f53003] px-5 py-1.5 text-sm leading-normal text-white hover:bg-[#c41e00] hover:border-[#c41e00] dark:border-[#FF4433] dark:bg-[#FF4433] dark:text-[#1C1C1A] dark:hover:bg-[#c41e00] dark:hover:border-[#c41e00]"
                            >
                                Register for Queue
                            </Link>
                        </li>
                        <li>
                            <Link
                                :href="route('public.queue')"
                                class="inline-block rounded-sm border border-[#1b1b18] bg-white px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:bg-[#f53003] hover:text-white hover:border-[#f53003] dark:border-[#EDEDEC] dark:bg-[#161615] dark:text-[#EDEDEC] dark:hover:bg-[#FF4433] dark:hover:text-[#1C1C1A] dark:hover:border-[#FF4433]"
                            >
                                Now Serving
                            </Link>
                        </li>
